// lib/presentation/auth/screens/teacher_login.dart
// Purpose: Teacher login screen with email and password fields
...
class _TeacherLoginScreenState extends State<TeacherLoginScreen> {
  ...
  Future<void> _handleLogin() async {
    if (_formKey.currentState!.validate()) {
      ...
      final success = await authProvider.teacherLogin(
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      return authProvider.teacherValidator.getEmailValidationMessage(value ?? '');
                    },
                  ),
                  ...
                  TextFormField(
                    ...
                    validator: (value) {
                      return authProvider.teacherValidator.getPasswordValidationMessage(value ?? '');
                    },
                  ),
